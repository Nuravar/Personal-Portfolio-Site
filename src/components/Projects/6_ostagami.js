    ...
    <Slide direction="bottom" in={isOpen} style={{ zIndex: 10, position: 'fixed', top: 0, left: 0, right: 0 }}>
      <div  style={{ maxHeight: '100%', overflowY: 'auto' }}>
        ...
        >
          ...
          <Box lassName="Header" >
            <Heading textColor="#1A202C" fontFamily="Clashgrotesk, sans-serif;" fontSize="70" mb="1">Ostagami</Heading>
            <Text color="gray">20/12/2021</Text>
          ...
          <Box className="Introduction" >
            ...
            <HStack flexDirection={{ base: 'column', md: 'row' }} spacing={10} >
              ...
              Our team was assigned the case of Leiko Wu, a colostomate facing challenges in achieving a balance between daytime profile and nighttime capacity using existing ostomy bags available in the market. In response, we developed the "Ostogami," a modular, foldable ostomy bag attachment that connects to the surface of an existing ostomy bag. This innovative solution addresses the sleeplessness experienced by many ostomates by increasing nighttime capacity while maintaining the user's outward profile. The Ostogami allows users to conveniently attach extra capacity whenever needed, providing a customizable and discreet solution for improved comfort and convenience.
              </Text> 
              </VStack>
              <VStack align="left" >
              <Heading textColor="#1A202C" fontFamily="Clashgrotesk, sans-serif;" fontSize={30} >My Role</Heading>
              <UnorderedList textColor="#1A202C" >
                <ListItem>Created the iris mechanism for opening and closing the device</ListItem>
